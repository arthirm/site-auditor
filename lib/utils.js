...
class ConfigUtils {
  ...
  static validate(config) {
    ...
    if (chrome === undefined || chrome.marker === undefined)
      msg += "'chrome.marker' not configured in config file.";
    ...
    if (msg) {
      msg +=
        ' Please refer to https://github.com/arthirm/site-audit/blob/master/README.md for configuring';
